            ...
            <form class="form" autocomplete="off" method="post" enctype="multipart/form-data" action="{{route('client.card.store')}}" novalidate>
                ...
                <fieldset>
                    ...
                    <div class="raf-box">
                        ...
                        مرد<input type="radio" class="raf-radio" id="sex" name="sex" value="male" checked/>
                        زن <input type="radio" class="raf-radio" id="sex" name="sex" value="female"/>
                    </div>
                ...
                <button class="btn" style="cursor: pointer"><i class="fa fa-lock"></i> ثبت نام</button>
            </form>
        </div>

    </div>
    <script src="{{asset('front/assets/js/create_card.js')}}"></script>
